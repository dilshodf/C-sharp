...
//5 9 2 3
//1 4 7 2
// Решим так чтобы смогли менять любую строчку с любой
...
int coulmns = Convert.ToInt32(Console.ReadLine());
...
int[,] myArray = Create2DArray(rows, coulmns);  // инициализировали массив
